...
In a previous PCA of this dataset, the samples separated into three separate clusters, which correlated with three groups of DNA extraction batches. 
...
We highly recommend that you keep track of batch effects (esp. DNA extraction and library prep batches), visualize your data with PCA on ranks or MDS, and separate your data into different blocks of necessary. 
