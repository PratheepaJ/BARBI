...
(Pratheepa, consider moving this line of code to p top.). 
...
Thus, split the phyloseq object into multiple phyloseq obecjts corresponding to each block, and store the phyloseq objects as a list of phyloseq objects, `psByBlock`. 
