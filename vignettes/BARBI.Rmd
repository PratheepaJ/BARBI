...
psBlockResult <- psBlockResults(ps, 
                                ...
                                caselevels = c("Healthy_Plasma","Patient_Plasma"), 
...
`add1 == TRUE` corresponds to adding 1 to the otu table and `add1 == FALSE` corresponds to choosing 'poscounts' for size factor calculation method in `DESeq::estimateSizeFactors`.
...
Choosing `stringent == TRUE` suggests to not using the scaling property for the species with mean intensity of contamination less than one.
