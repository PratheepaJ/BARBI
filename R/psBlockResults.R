...
#' @param sampleName character, variable defines the sample names in the sample data of phyloseq.
...
#'
#' @return A list of phyloseq objects, phyloseq of negative control samples by block, phyloseq of taxa with prevalence zero in negative control samples by block, phyloseq of specimen-samples by block.
#' @import phyloseq
#' @export
